...
public final class WorkflowEngine extends SimEntity {
    ...
    public <T extends Cloudlet> void replaceJobsList(List<T> jobsList) {
        // Use the private setter to replace the entire internal list
        setJobsList(jobsList);
        
        // Also clear the submitted list and reset counter to ensure a clean start
        if (this.jobsSubmittedList != null) {
             this.jobsSubmittedList.clear();
        }
